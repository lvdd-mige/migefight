...
def Train_args(Time):
    ...
    # 文件路径设置
    parser.add_argument('--train_dataroot', default="Dataset//Public")
    parser.add_argument('--test_dataroot', default="Dataset//ZD_TRAIN")
    parser.add_argument('--logroot', default="Logs")


    #架构设置
    parser.add_argument('--Net_Name', default="UNet",help="UNet,U2Net,EINET")
    ...
    with open(os.path.join(Log_PATH,'setting.txt'), "w") as f:
